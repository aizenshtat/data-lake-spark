...
def process_song_data(spark, input_data, output_data):
    """
    The function reads data from song_data dataset from S3, processes that data using Spark, and writes them back to S3 in form of songs_table and artists_table parquet files
...
def process_log_data(spark, input_data, output_data):
    """
        The function reads data from log_data dataset from S3, processes that data using Spark, and writes them back to S3 in form of users_table, time_table and songplays_table parquet files
...
def main():
    ...
    output_data = "s3a://data-lake-spark/"
